...
public class UserFactory {
    public User createUser(int id, Set<Role> rolesToAssign, String username, String personalEmail, String employeeEmail,
                           String firstName, String middleName, String lastName) {
        User newUser = new User(id, username, personalEmail, employeeEmail, firstName, middleName, lastName);
