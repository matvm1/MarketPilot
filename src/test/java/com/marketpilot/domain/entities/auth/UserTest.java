...
class UserTest {
    ...
    @BeforeEach
    void setUp() {
        testUser = new User(1, "johnmdoe", "johnmdoe@outlook.com",
    ...
    void constructor_throwsForNonPositiveId() {
        assertThrows(IllegalArgumentException.class, () ->
                new User(0, "johnmdoe", "johnmdoe@outlook.com",
                        "johnmdoe@company.com","John", "M", "Doe"));
    }
    ...
    void constructor_throwsForNullUsername() {
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, null, "johnmdoe@outlook.com",
                                "johnmdoe@company.com","John", "M", "Doe"),
    ...
    void constructor_throwsForBlankUsername() {
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "     ", "johnmdoe@outlook.com",
                                "johnmdoe@company.com","John", "M", "Doe"),
                "Expected constructor to throw for null first name");
    }
    ...
    void constructor_throwsForInvalidPersonalEmailPatterns() {
        ...
        // Domain without TLD
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", "user@localhost",
                                null,"John", "M", "Doe"),
        ...
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", longLocalPart + "@example.com",
                                null,"John", "M", "Doe"),
        ...
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", "user@" + longDomain,
                                null,"John", "M", "Doe"),
    ...
    void constructor_throwsForInvalidEmployeeEmailPatterns() {
        ...
        // Domain without TLD
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", null, "user@localhost",
                                "John", "M", "Doe"),
        ...
        String longLocalPart = "a".repeat(65);
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", null, longLocalPart + "@example.com",
                                "John", "M", "Doe"),
        ...
        String longDomain = "a".repeat(250) + ".com";
        assertThrows(IllegalArgumentException.class, () ->
                        new User(1, "johnmdoe", null, "user@" + longDomain,
                                "John", "M", "Doe"),
